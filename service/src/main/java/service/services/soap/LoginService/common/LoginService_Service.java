 ...
 * 
 */
@WebServiceClient(name = "LoginService", targetNamespace = "http://common.dip.com/", wsdlLocation = "file:/C:/Java/Workspace/Diplom/root/wsdl/LoginService.wsdl")
    ...
    extends Service
{
    ...
    private final static QName LOGINSERVICE_QNAME = new QName("http://common.dip.com/", "LoginService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/C:/Java/Workspace/Diplom/root/wsdl/LoginService.wsdl");
    ...
    public LoginService getServicePort() {
        return super.getPort(new QName("http://common.dip.com/", "ServicePort"), LoginService.class);
    }
     ...
     */
    @WebEndpoint(name = "ServicePort")
    public LoginService getServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://common.dip.com/", "ServicePort"), LoginService.class, features);
    }
